...
const {createAiHistory, updateConversation, getBehaviourRecommendation, getHabitatRecommendation, getNutritionRecommendation, getTreatmentRecommendation, getSummarizeRecommendation, getAllHistoryChat, createAIRecommendation, getAllRecommendationsAndSave} = require('../controllers/aiController');
