...
function ReptileHealthTrackingPage() {
  ...
  const [sleepingStatus, setSleepingStatus] = useState([{ status: "", date: "" }])
  const [sleepingHistory, setSleepingHistory] = useState([{ date: "", hours: "" }])
  const [treatmentHistory, setTreatmentHistory] = useState([
    { disease: "", treatment_date: "", next_treatment_date: "", doctor_feedback: "", treatment_medicine: "", note: "" },
  ])
        ...
        <div style={styles.headerSection}>
          ...
          <div style={styles.pageTitle}>
            ...
            <div>
              ...
              <p style={styles.subtitle}>Ghi lại thông tin sức khỏe chi tiết cho thú cưng của bạn</p>
            </div>
          </div>
        </div>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Card style={styles.sectionCard}>
            ...
            <Card.Body style={styles.sectionContent}>
              <div style={styles.currentWeightContainer}>
                <Form.Group>
                  <Form.Label style={styles.formLabel}>Cân nặng (gram)</Form.Label>
                  <Form.Control
                    type="number"
                    value={currentWeight}
          ...
          <Card style={styles.sectionCard}>
            ...
            <Card.Body style={styles.sectionContent}>
                      ...
                      >
                        <td style={styles.tableCell}>
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setSleepingStatus((h) =>
                                h.map((r, i) => (i === idx ? { ...r, status: e.target.value } : r)),
                              )
                            }
                        ...
                        <td style={styles.tableCell}>
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setSleepingStatus((h) =>
                                h.map((r, i) => (i === idx ? { ...r, date: e.target.value } : r)),
                              )
                            }
                            style={styles.formInput}
                            required
                        ...
                        <td style={styles.tableCell}>
                          <button
                            type="button"
                            onClick={() => handleRemoveRow(setSleepingStatus, idx)}
                            disabled={sleepingStatus.length === 1}
                            style={{
                              ...styles.removeButton,
                              opacity: sleepingStatus.length === 1 ? 0.5 : 1,
                              cursor: sleepingStatus.length === 1 ? "not-allowed" : "pointer",
                            }}
                            onMouseEnter={(e) => {
              ...
              <button
                type="button"
                onClick={() => handleAddRow(setSleepingStatus, { status: "", date: "" })}
                style={styles.addButton}
                onMouseEnter={(e) => {
                  e.target.style.backgroundColor = "#f0fdf4"
                  e.target.style.borderColor = "#16a34a"
          ...
          <Card style={styles.sectionCard}>
            ...
            <Card.Body style={styles.sectionContent}>
                      ...
                      >
                        ...
                        <td style={styles.tableCell}>
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setSleepingHistory((h) =>
                                h.map((r, i) => (i === idx ? { ...r, hours: e.target.value } : r)),
                              )
                            }
                            placeholder="Số giờ..."
                            style={styles.formInput}
                        ...
                        <td style={styles.tableCell}>
                          <button
                            type="button"
                            onClick={() => handleRemoveRow(setSleepingHistory, idx)}
                            disabled={sleepingHistory.length === 1}
                            style={{
                              ...styles.removeButton,
                              opacity: sleepingHistory.length === 1 ? 0.5 : 1,
                              cursor: sleepingHistory.length === 1 ? "not-allowed" : "pointer",
                            }}
                            onMouseEnter={(e) => {
              ...
              <button
                type="button"
                onClick={() => handleAddRow(setSleepingHistory, { date: "", hours: "" })}
                style={styles.addButton}
                onMouseEnter={(e) => {
                  e.target.style.backgroundColor = "#f0fdf4"
                  e.target.style.borderColor = "#16a34a"
            ...
            <Card.Body style={styles.sectionContent}>
              <div style={{ ...styles.tableContainer, ...styles.wideTable }}>
                <Table responsive className="mb-0">
                  <thead style={styles.tableHeader}>
                    <tr>
                      <th style={{ ...styles.tableHeaderCell, minWidth: "180px" }}>Ngày giờ</th>
                      <th style={{ ...styles.tableHeaderCell, minWidth: "120px" }}>Thức ăn</th>
                      <th style={{ ...styles.tableHeaderCell, minWidth: "100px" }}>Số lượng</th>
                      <th style={{ ...styles.tableHeaderCell, minWidth: "80px" }}>Nhịn ăn</th>
                      <th style={{ ...styles.tableHeaderCell, minWidth: "120px" }}>Tình trạng phân</th>
                      <th style={{ ...styles.tableHeaderCell, width: "60px" }}></th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      >
                          ...
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setNutritionHistory((h) =>
                                h.map((r, i) => (i === idx ? { ...r, created_at: e.target.value } : r)),
                              )
                            }
                            style={styles.formInput}
                            required
                        ...
                        <td style={styles.tableCell}>
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setNutritionHistory((h) =>
                                h.map((r, i) => (i === idx ? { ...r, food_items: e.target.value } : r)),
                              )
                            }
                            placeholder="Thức ăn..."
                            style={styles.formInput}
                        ...
                        <td style={styles.tableCell}>
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setNutritionHistory((h) =>
                                h.map((r, i) => (i === idx ? { ...r, food_quantity: e.target.value } : r)),
                              )
                            }
                        ...
                        <td style={{ ...styles.tableCell, textAlign: "center" }}>
                          <Form.Check
                            ...
                            onChange={(e) =>
                              setNutritionHistory((h) =>
                                h.map((r, i) => (i === idx ? { ...r, is_fasting: e.target.checked } : r)),
                              )
                            }
                        ...
                        <td style={styles.tableCell}>
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setNutritionHistory((h) =>
                                h.map((r, i) => (i === idx ? { ...r, feces_condition: e.target.value } : r)),
                              )
                            }
                        ...
                        <td style={styles.tableCell}>
                          <button
                            type="button"
                            onClick={() => handleRemoveRow(setNutritionHistory, idx)}
                            disabled={nutritionHistory.length === 1}
                            style={{
                              ...styles.removeButton,
                              opacity: nutritionHistory.length === 1 ? 0.5 : 1,
                              cursor: nutritionHistory.length === 1 ? "not-allowed" : "pointer",
                            }}
                            onMouseEnter={(e) => {
