      ...
      <div className="navigation-content">
        <nav className="navigation-menu">
          ...
          <div className={`menu-item ${activeItem === 'personal' ? 'active' : ''}`}
            ...
            <a className="menu-text" href="/Profile">Cá nhân</a>
          </div>
          ...
          <div className={`menu-item ${activeItem === 'security' ? 'active' : ''}`}
            ...
            <a className="menu-text" href="/Security">Bảo mật</a>
          </div>
          ...
          <div className={`menu-item ${activeItem === 'upgrade' ? 'active' : ''}`}
            ...
            <a className="menu-text" href="#">Nâng cấp tài khoản</a>
          </div>
          ...
          <div className={`menu-item ${activeItem === 'transaction' ? 'active' : ''}`}
            ...
            <a className="menu-text" href="/Transaction">Giao dịch</a>
          </div>
          ...
          <div className={`menu-item ${activeItem === 'settings' ? 'active' : ''}`}
            ...
            <a className="menu-text" href="/Settings">Cài đặt</a>
          </div>
        </nav>
      </div>
    </div>
